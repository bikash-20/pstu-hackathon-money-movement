...
## Component Choices
1. **Frontend (Next.js / Vercel):** Fast to set up, built-in API routes if needed (though we will use a separate backend), and Vercel's free tier is extremely reliable for live demos.
